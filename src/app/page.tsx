...
export default function Page() {
  ...
  return (
    <main>
      ...
      <section id="about" className="section paper-section page-section"><div className="section-wrap about-grid"><div><SectionLabel icon={Quote}>Profile</SectionLabel><h2>Curious by nature.<br /><em>Precise by practice.</em></h2></div><div className="about-text"><p>My work sits at the intersection of reliable engineering and emerging intelligence. I enjoy understanding a system from first principles, then shaping it into something people can actually use.</p><div className="fact-grid"><div><MapPin size={17} /><span>Karachi, Sindh</span></div><div><GraduationCap size={17} /><span>FAST NUCES, 2023 to 2027</span></div><div><Terminal size={17} /><span>Software and AI</span></div><div><Users size={17} /><span>Teaching and mentoring</span></div></div></div></div></section>
